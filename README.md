...
Most mods will work fine with this mod.
A few mods have received special support to improve their use with a controller.
...
- Cursor height is buggy
- Demolish (& others) tooltip in wrong spot
- Resource counter slider doesn't update when moved with shoulders
